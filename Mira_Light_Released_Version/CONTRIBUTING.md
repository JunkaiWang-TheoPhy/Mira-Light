...
- keeping `scripts/`, `tools/`, `web/`, `docs/`, and `Figs/motions/` in sync
...
2. update the matching `Figs/motions/<scene>/README.md`
3. update the relevant release docs if behavior or scope changed
