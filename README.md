...
按照 Playbook 的提交要求，这个仓库已经承载了核心代码与技术说明，剩余材料可以直接围绕本仓库补齐：
...
> 我们在做具身化 AI 交互，让感知、情绪与动作在真实空间里形成闭环。

## 原创与 AI 使用说明

Mira Light 是一个原创项目。我们使用了 AI 辅助开发工具来提高调研、编码、文档整理和迭代效率，但项目的问题定义、产品方向、系统架构、场景设计、交互表达和最终实现选择都由团队主导完成。
