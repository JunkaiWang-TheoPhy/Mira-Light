...
def build_steps(*, party_light: str) -> list[RemoteStep]:
    return [
        ...
        RemoteStep(
            ...
            f"python3 /home/sunrise/Desktop/servo_12_slow_to_1800_2750.py --target-1 2440 --target-2 2280 --speed-1 {_speed(185)} --speed-2 {_speed(205)}",
        ),
        RemoteStep(
        ...
        RemoteStep(
            "upper sway right only",
            f"python3 /home/sunrise/Desktop/four_servo_control.py pose 2535 2600 2200 2040 --speeds {_speed(270)} {_speed(175)} {_speed(230)} {_speed(175)}",
        ),
        RemoteStep("hold upper-right", _sleep(0.35)),
        RemoteStep(
...
def main() -> None:
    parser = build_parser("Single right-up celebration round test derived from Videos/05.")
